...
export const SECTION_SCHEMAS: Record<HomepageSectionType, SectionSchema> = {
  ...
  why_choose_us: {
    label: "Why choose us",
    description: "Benefits and trust signals.",
    fields: [
      ...titleFields,
      { key: "benefit1", label: "Benefit one title", type: "text" },
      { key: "benefit1Desc", label: "Benefit one description", type: "textarea" },
      { key: "benefit2", label: "Benefit two title", type: "text" },
      { key: "benefit2Desc", label: "Benefit two description", type: "textarea" },
      { key: "benefit3", label: "Benefit three title", type: "text" },
      { key: "benefit3Desc", label: "Benefit three description", type: "textarea" },
      { key: "benefit4", label: "Benefit four title", type: "text" },
      { key: "benefit4Desc", label: "Benefit four description", type: "textarea" },
      { key: "chip1", label: "Trust chip one", type: "text" },
      { key: "chip2", label: "Trust chip two", type: "text" },
      { key: "chip3", label: "Trust chip three", type: "text" },
      { key: "chip4", label: "Trust chip four", type: "text" },
    ],
    defaultData: {
      title: "Why customers choose us",
      subtitle: "Thoughtful service at every step.",
      benefit1: "Premium quality",
      benefit1Desc: "Every jar pickled in small batches for real, consistent flavor.",
      benefit2: "Secure payment",
      benefit2Desc: "No shortcuts or fillers. Just peppers doing what they do best.",
      benefit3: "Fast delivery",
      benefit3Desc: "Fresh jars at your door across Riyadh, Jeddah and Dammam.",
      benefit4: "Easy returns",
      benefit4Desc: "Encrypted checkout with every major payment method.",
      chip1: "No Preservatives",
      chip2: "Eco-Friendly Packaging",
      chip3: "Live Order Tracking",
      chip4: "24/7 Customer Support",
    },
  },
  about_teaser: { label: "Image with text", description: "Editorial brand storytelling block.", fields: [...titleFields, { key: "body", label: "Body copy", type: "textarea" }, { key: "body2", label: "Second paragraph", type: "textarea" }, { key: "image", label: "Image", type: "image" }, { key: "imageAlt", label: "Image alt text", type: "text", required: true }, { key: "ctaText", label: "CTA text", type: "text" }, { key: "ctaLink", label: "CTA link", type: "text" }, { key: "imagePosition", label: "Image position", type: "select", options: [{ label: "Left", value: "left" }, { label: "Right", value: "right" }] }], defaultData: { title: "Our story", subtitle: "Made with purpose.", body: "Share the craft, people, and principles behind your brand.", body2: "", image: "", imageAlt: "Our brand story", ctaText: "Learn more", ctaLink: "/about", imagePosition: "left" } },
