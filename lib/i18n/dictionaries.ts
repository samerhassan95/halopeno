export const dictionaries = {
  en: {
      ...
      noResultsHint: "Try adjusting your search, or add a new entry.",
      actions: "Actions",
      edit: "Edit",
      delete: "Delete",
      view: "View",
      ...
      deleteEntries: "Delete {count} entries?",
      ...
      createdOk: "{title} entry created",
      exportedOk: "Exported {count} rows",
      apiUnreachable: "Live API unreachable ({error}).",
      addTitle: "Add {title}",
  ...
  ar: {
    common: {
      ...
      noResultsHint: "جرّب تعديل البحث، أو أضف إدخالاً جديدًا.",
      actions: "إجراءات",
      edit: "تعديل",
      delete: "حذف",
      view: "عرض",
      ...
      deleteEntries: "حذف {count} إدخالات؟",
      ...
      createdOk: "تم إنشاء إدخال {title}",
      exportedOk: "تم تصدير {count} صفوف",
      apiUnreachable: "تعذّر الوصول إلى واجهة البرمجة ({error}).",
